...
from dc.utils.version import version
...
setup(
    ...
    description = 'digicert cli in Python',
    long_description = README,
    url = 'https://github.com/mozilla-it/dc-cli',
    author = 'Scott Idler',
    ...
    entry_points = dict(console_scripts=['dc=dc.cli:main']),
)
